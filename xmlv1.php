...
$pe3 = array();
$pe3['nombre'] = "INDUSTRIA DE ALIMENTOS Y BEBIDAS";
$pe3['modulos'] = [];

$pe4 = array();
$pe4['nombre'] = "MECANICA AUTOMOTRIZ";
$pe4['modulos'] = [];
...
foreach(($ies["programas_estudio"]) as $indice => $PEs){
    ...
    foreach($PEs['modulos'] as $indice_modulo =>$Modulo){
        ...
        $nun_mod->appendChild($nom_mod);
        $num_pe->appendChild($nun_mod);
    }
